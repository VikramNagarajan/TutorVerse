const Services = () => {
  return (
    <div id="services" className="flex flex-col font-mono w-full pt-10 pb-20 bg-dark">
        ...
        <div className="card card-side bg-emerald-700  shadow-xl text-xl w-3/12 hidden xl:flex" style={{ marginRight: '6rem' }}>
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <button className="btn btn-accent text-black hover:scale-x-125 hover:scale-y-125 text-lg">Try for free!</button>
            </div>
          </div>
        </div>
        <div className="card card-side bg-teal-700 shadow-xl text-xl w-3/12 hidden xl:flex">
         {/*  <figure><img src="/images/stock/photo-1635805737707-575885ab0820.jpg" alt="Movie" /></figure> */}
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <button className="btn btn-primary text-black hover:scale-x-125 hover:scale-y-125 text-lg">Try for free!</button>
            </div>
          </div>
        </div>
      </div> 
