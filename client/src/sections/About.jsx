  ...
  return (
    <div id="about-us" className="flex flex-col items-center font-mono w-full justify-center pt-10 pb-10">
      ...
      <div className="w-1/2 hidden xl:flex pt-5">
        ...
        <details className="collapse collapse-arrow bg-neutral-800">
          <summary className="collapse-title text-2xl font-medium text-left text-white">What We Do</summary>
      ...
      <div className="w-1/2 hidden xl:flex pt-8">
        ...
        <details className="collapse collapse-arrow bg-neutral-800">
          <summary className="collapse-title text-2xl font-medium text-left text-white">Our Mission</summary>
          <div className="collapse-content"> 
            <p className="text-left text-xl">
            At TutorVerse, our mission is to simplify and enhance the learning experience by connecting individuals with the right educational resources and communities. We strive to create a platform where students can easily find expert tutors, join study groups, or pair up with study buddies, aell tailored to their unique learning needs and goals. Our vision is to foster a collaborative and supportive learning environment that encourages continuous academic growth, knowledge sharing, and the meaningful exchange of ideas. Through TutorVerse, we aim to make education more accessible, engaging, and effective for every learner.
            </p>
          </div>
        </details>
      </div>
      ...
      <div className="w-1/2 hidden xl:flex pt-8">
        <details className="collapse collapse-arrow bg-neutral-800">
          <summary className="collapse-title text-2xl font-medium text-left text-white">Our Story</summary>
          <div className="collapse-content"> 
            <p className="text-left text-xl">
        ...
        <div className="pt-6">
          <div className="card w-96 shadow-xl xl:hidden bg-neutral-800">
            <div className="card-body items-center">
              <h2 className="card-title text-2xl text-center text-white">For Students.</h2>
              <h2 className="card-title text-2xl text-center text-white">By Students.</h2>
              <br></br>
